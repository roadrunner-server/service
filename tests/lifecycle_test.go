...
func TestServiceInit(t *testing.T) {
	rr, _ := helpers.Start(t, "configs/.rr-service-init.yaml", []any{&service.Plugin{}},
...
func TestServiceStdout(t *testing.T) {
	rr, _ := helpers.Start(t, "configs/.rr-service-init-stdout.yaml", []any{&service.Plugin{}},
...
func TestServiceEnv(t *testing.T) {
	rr, _ := helpers.Start(t, "configs/.rr-service-env.yaml", []any{&service.Plugin{}},
		helpers.WithServicesStarted(1))
...
func TestServiceTrimOutput(t *testing.T) {
	rr, _ := helpers.Start(t, "configs/.rr-service-newlines.yaml", []any{&service.Plugin{}},
		helpers.WithServicesStarted(1))

	rr.WaitLogsExact(t, "stdout write", 1)
}

func TestServiceCommandNotFound(t *testing.T) {
	rr, _ := helpers.Start(t, "configs/.rr-service-error.yaml", []any{&service.Plugin{}},
		helpers.WithServicesStarted(1))
...
func TestServiceExitRestart(t *testing.T) {
	rr, _ := helpers.Start(t, "configs/.rr-service-restarts.yaml", []any{&service.Plugin{}},
		helpers.WithServicesStarted(1))
